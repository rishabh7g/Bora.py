...
import CelebrationScreen, { celebrationTriggered } from '../screens/CelebrationScreen';
...
import HomeMap, {
  ...
  SETUP_ROUTE,
  SHELF_ROUTE,
} from '../screens/HomeMap';
import ModuleView from '../screens/ModuleView';
import PhotocardShelf from '../components/PhotocardShelf';
...
/** The one frame every screen renders inside (#73, src/app/app.css): a full-height
...
function Shell({ children }: { children: ReactNode }) {
  ...
  // object to — see the `scroll-behavior` note in src/app/app.css.
  useLayoutEffect(() => {
