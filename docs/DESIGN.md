...
- **Photocard shelf:** the collected cards at full size, cracked corners visible; the checkpoints still ahead as one strip of numbered slots, no card face and no caption
